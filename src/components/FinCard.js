...
const FinCard = ({ fin }) => {
	return (
		<div className="card-container">
			<Member
				name={fin.player}
				imgSrc={fin.player === "Röder" ? roederPic : fin.player === "TrilluXe" ? trilluxePic : fin.player === "Marf" ? marfPic : fin.player === "Blader" ? bladerPic : fin.player === "Fibu" ? fibuPic : schweinePic}
			/>
